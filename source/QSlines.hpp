 ...
 */ 
template <typename T>
int Catenary(T XF, T ZF, T L, T EA, T W, T CB, T Tol,
             T* HFout, T* VFout, T* HAout, T* VAout,
             unsigned int Nnodes, const vector<T> &s,
             vector<T> &X, vector<T> &Z, vector<T> &Te)
{
    if (longwinded==1)
    ...
    for(unsigned int I = 1; I <= MaxIter; I++) {
        ...
        if((CB < 0.0) || (W < 0.0) || (VFMinWL > 0.0)) {
            ...
            dXFdHF = (log(VFOvrHF + SQRT1VFOvrHF2) -
                ...
                (VFMinWLOvrHF + SQRT1VFMinWLOvrHF2)) / W + LOvrEA;
            dXFdVF = ((1.0 + VFOvrHF /SQRT1VFOvrHF2) /
                (VFOvrHF + SQRT1VFOvrHF2) -
            ...
            // .TRUE. when a portion of the line rests on the seabed and the anchor tension is nonzero
            EXF = log(VFOvrHF + SQRT1VFOvrHF2) * HFOvrW -
                0.5 * CBOvrEA * W * LMinVFOvrW*LMinVFOvrW +
                LOvrEA * HF + LMinVFOvrW - XF;
            EZF = (SQRT1VFOvrHF2 - 1.0) * HFOvrW + 0.5 * VF * VFOvrWEA - ZF;

            dXFdHF = log(VFOvrHF + SQRT1VFOvrHF2) / W -
                ((VFOvrHF + VFOvrHF2 / SQRT1VFOvrHF2) /
                (VFOvrHF + SQRT1VFOvrHF2)) / W + LOvrEA;
            dXFdVF = ((1.0 + VFOvrHF / SQRT1VFOvrHF2) /
                (VFOvrHF + SQRT1VFOvrHF2)) / W + CBOvrEA * LMinVFOvrW - 1.0 / W;
            ...
            dXFdHF = log(VFOvrHF + SQRT1VFOvrHF2) / W -
                ((VFOvrHF + VFOvrHF2 / SQRT1VFOvrHF2) /
                (VFOvrHF + SQRT1VFOvrHF2)) / W +
                LOvrEA - (LMinVFOvrW - HFOvrW / CB) / EA;
            dXFdVF = ((1.0 + VFOvrHF / SQRT1VFOvrHF2) /
                (VFOvrHF + SQRT1VFOvrHF2)) / W + HFOvrWEA - 1.0 / W;
            dZFdHF = (SQRT1VFOvrHF2 - 1.0 - VFOvrHF2 / SQRT1VFOvrHF2) / W;
            dZFdVF = (VFOvrHF / SQRT1VFOvrHF2) / W + VFOvrWEA;
        }
    ...
    if((CB < 0.0) || (W < 0.0) || (VFMinWL > 0.0))
    {
        ...
        for (unsigned int I = 0; I < Nnodes; I++)
        {
            ...
            X[I] = (log(VFMinWLsOvrHF + SQRT1VFMinWLsOvrHF2) -
                log(VFMinWLOvrHF + SQRT1VFMinWLOvrHF2)) * HFOvrW + sOvrEA * HF;

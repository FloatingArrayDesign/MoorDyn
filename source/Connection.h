 ...
 * @return The connection identifier, MOORDYN_INVALID_VALUE if a NULL connection
 * is provided
 */
 ...
 * @warning MOORDYN_INVALID_VALUE matchs the value of Connection::COUPLED, i.e.
 * the returned value cannot be reliably used as error handling
 */
